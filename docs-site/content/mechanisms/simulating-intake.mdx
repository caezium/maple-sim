...
<img src="media/intakesim2.png" alt="" style={{ width: "49%" }} />
<img src="media/intakesim3.png" alt="" />
</div>
...
<Tabs items={["In-The-Frame (ITF) Intakes", "Over-The-Bumper (OTB) Intakes", "Custom Shape Intakes"]}>
<Tab value="In-The-Frame (ITF) Intakes">

<div style={{ display: "flex", alignItems: "center" }}>
    <div style={{ alignItems: "center", width: "29%" }}>
        <img src="../media/intakesim3.png" style={{ maxHeight: "100%", margin: "auto" }} />
    </div>
...
<Tab value="Over-The-Bumper (OTB) Intakes">

<div style={{ display: "flex", alignItems: "center" }}>
    <div style={{ alignItems: "center", width: "29%" }}> 
        <img src="../media/intakesim2.png" style={{ maxHeight: "100%", margin: "auto" }} />
    </div>
    <div style={{ width: "70%", fontSize: "13px" }}>
        ```text
...
<Tab value="Custom Shape Intakes">
...
<Callout type="tip">
  ...
  As shown in the code above, you can notify `FlyWheelIOSim` (the simulated flywheel mechansim) to shoot the note out when the note is passed to the shooter from the intake. See [Simulating GamePiece Projectiles](./simulating-projectiles) for more details.
