---
title: "Simulating GamePiece Projectiles"
---
...
The real-time positions of the flying game pieces are also visualized with other game pieces, as described [here](./core-concepts/using-the-simulated-arena#visualizing-game-pieces).
