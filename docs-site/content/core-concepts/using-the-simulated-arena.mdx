---
title: "Using the Simulated Arena Object"
---
...
Your robot can interact with these pieces by bumping into them or grabbing them (see [Intake Simulation](../mechanisms/simulating-intake)).
...
<Tabs items={["AdvantageKit", "WPILib Networktables"]}>
<Tab value="AdvantageKit">
...
<Tab value="WPILib Networktables">
