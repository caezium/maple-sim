...
<details>
<summary>Why a Physics Engine?</summary>
...
<details>
<summary>Other Custom Templates & Examples</summary>
...
1. [Installing maple-sim](./getting-started/installing-maple-sim)
2. [Using the Simulated Arena](./core-concepts/using-the-simulated-arena)
3. [Simulating Swerve Drivetrain](./swerve-simulation/swerve-simulation-overview)
4. [Simulating Intake](./mechanisms/simulating-intake)
5. [Simulating Projectiles](./mechanisms/simulating-projectiles)
6. [Simulating Opponent Robots](./match-simulation/simulating-opponent-robots)
