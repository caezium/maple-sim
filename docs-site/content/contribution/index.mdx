...
<Callout type="success" title="**Things you should do**">
...
<Callout type="error" title="**Things to avoid**">
...
<img src="./media/publish%20to%20maven%20local.png" alt="" style={{ width: "30%" }} />
